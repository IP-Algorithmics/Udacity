...
'''
Above we have a simple linked list with two elements, [1, 2]. 
...
However, prepending (adding to the head of the list) can be done in constant  𝑂(1)  time. You'll implement this prepend method in the Linked List Practice.ipynb notebook.
'''
...
We usually want to detect if there is a loop in our linked lists to avoid these problems. You'll get a chance to implement a solution for detecting loops later in the lesson.
'''
