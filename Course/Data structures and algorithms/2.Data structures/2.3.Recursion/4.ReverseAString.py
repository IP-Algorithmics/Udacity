'''
Reversing a String¶.
TThe goal in this notebook will be to get practice with a problem that is frequently solved by recursion: Reversing a string.
...
def reverse_string(input):
    ...
    if len(input) == 0:
        ...
        '''
        the_rest = slice(
            1, None)     # `the_rest` is an object of type 'slice' class
